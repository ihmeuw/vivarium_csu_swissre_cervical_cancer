...
PREVALENCE_DISTS = {
    ...
    # the infection rate of high-risk HPVs in women aged <25, 25-45, and >45 years
    # was 24.3% (95%CI, 19.0%-29.6%), 19.9% (95%CI, 16.4-23.4), and 21.4% (95%CI, 17.3-25.5), respectively.
    CERVICAL_CANCER.BCC_PREVALENCE_RATIO: TruncnormDist(
        CERVICAL_CANCER.BCC_PREVALENCE_RATIO, 0.07, 0.06, 0.0, 100.0
    ),
    CERVICAL_CANCER.HRHPV_PREVALENCE: TruncnormDist(
        CERVICAL_CANCER.HRHPV_PREVALENCE, 0.33, 0.10, 0.0, 100.0
    ),
}
